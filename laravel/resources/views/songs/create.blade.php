...
@section('content')
<div class="main-content song-create-container">
    <h1 class="main-title">New Song</h1>
    @if(session('error'))
    ...
    @endif
    <form class="song-create-form" action="/songs" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="number" name="duration" class="form-control" value="{{ old('duration') }}" min="1" required>
        </div>
